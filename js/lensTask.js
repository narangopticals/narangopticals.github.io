...
export async function submit() {
    var rightType = "";
    var leftType = "";
    var rightSph = Number.parseFloat(rightSph_elem.value).toFixed(2);
    var leftSph = Number.parseFloat(leftSph_elem.value).toFixed(2);
    var rightCyl = Number.parseFloat(rightCyl_elem.value).toFixed(2);
    var leftCyl = Number.parseFloat(leftCyl_elem.value).toFixed(2);
    var rightAxis = Number.parseFloat(rightAxis_elem.value).toFixed(2);
    var leftAxis = Number.parseFloat(leftAxis_elem.value).toFixed(2);
    var rightAdd = Number.parseFloat(rightAdd_elem.value).toFixed(2);
    var leftAdd = Number.parseFloat(leftAdd_elem.value).toFixed(2);
